...
<div class="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 flex items-center justify-center px-4 py-12">
  <div class="max-w-md w-full">
    <div class="relative bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border-2 border-white/50 p-8 hover:shadow-orange-200/50 transition-all duration-300">
      ...
      <div class="flex justify-center mb-6 animate-slide-down">
        <div class="relative">
          <div class="w-20 h-20 rounded-3xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center shadow-xl">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-white" viewBox="0 0 24 24" stroke="currentColor" fill="none">
      ...
      <h1 class="text-3xl font-bold text-gray-900 text-center mb-2">Connexion administrateur</h1>
      <p class="text-lg text-gray-700 font-medium text-center mb-6">Accès réservé au personnel autorisé</p>
