                    ...
                    <div class="relative z-10 flex-1 flex flex-col">
                      ...
                      <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div class="text-xs text-gray-500">
                          ...
                          {new Date(document.created_at).toLocaleDateString('fr-FR', { day: 'numeric', month: 'short', year: 'numeric' })}
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div class="flex items-center gap-2 mt-2 text-sm text-gray-600">
                              ...
                              <span class="font-semibold">Émise le {new Date(prescription.issued_at).toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
                            </div>
                          </div>
                        </div>
